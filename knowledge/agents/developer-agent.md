...
4. **Coding Standards**: Python code must conform to Python 3.12+ features, using async/await endpoints and type hinting. Frontend components must use TypeScript and vanilla CSS (avoiding ad-hoc utility classes).
